({
  ...
  fileExclusionRegExp: /\.git|.sass-cache|sass|tool|component|0328|112313|ballandbuck|zerouv|minted|revolverBuild|revolver|taylorstitch|taylorStitch|midnightrider|teacollection|modcloth|showroom|square|config.rb|docs|index.js/
})
