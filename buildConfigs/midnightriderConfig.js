({
  ...
  fileExclusionRegExp: /\.git|.sass-cache|sass|tool|component|0328|112313|revolverBuild|revolver|taylorstitch|teacollection|modcloth|showroom|square|config.rb|docs|index.js/
})
