...
(function() {
    ...
    $(window).load(function() {
        ...
        if (i.animationName !== undefined) {
            e = true
        }
        if (e === false) {
            for (var s = 0; s < r.length; s++) {
                if (i[r[s] + "AnimationName"] !== undefined) {
                    prefix = r[s];
                    t = prefix + "Animation";
        ...
        generate: function(e) {
            ...
            if (a.length > 0) {
                ...
                var f = $("*").filter(function() {
                    return this.style[t + "Name"] === r
                });
                f.each(function() {
                    var e = $(this);
                    var t = e.data("keyframeOptions");
    ...
    var s = "animation-play-state";
    var o = "running";
    $.fn.resetKeyframe = function(e) {
        var t = $(this).css(n + s, o).css(n + "animation", "none");
        if (e) {
            setTimeout(e, 1)
        }
    };
    ...
    $.fn.playKeyframe = function(e, t) {
        var r = function(e) {
            ...
            return [e.name, e.duration, e.timingFunction, e.delay, e.iterationCount, e.direction, e.fillMode].join(" ")
        };
        var i = "";
        if ($.isArray(e)) {
            var u = [];
        ...
        this.each(function() {
            var r = $(this).addClass("boostKeyframe").css(n + s, o).css(f, i).data("keyframeOptions", e);
            if (t) {
                c(r, "AnimationIteration", t);
                c(r, "AnimationEnd", t)
            }
        });
        return this
    };
    i("boost-keyframe", " .boostKeyframe{" + n + "transform:scale3d(1,1,1);}")
}).call(this)
