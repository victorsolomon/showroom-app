    ...
    return {
        ...
        logAnalyticEvent : function( eventConfig, pageLevelVars ){
            ...
            var category = eventConfig.category,
                ...
                opt_label = eventConfig.opt_label,
                opt_value = eventConfig.opt_value,
                opt_noninteraction = eventConfig.opt_noninteraction;
            ...
            for( i = this.ROLLING_GA_INDEX; i > this.MODULE_GA_INDEX; i -- )
                this.deleteCustomVar( i );
        },

        logWatchInterval : function(){
            return;
            totalSessionTime = new Date().getTime() - this.sessionStartTime;
            currentPlaybackTime = videoController.getCurrentTime();
            pageLevelVars = { 'totalSessionTime' : totalSessionTime, 'currentPlaybackTime' : currentPlaybackTime };
