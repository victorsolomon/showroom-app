...
(function(window, undefined) {
  "use strict";
    ...
    if (Proto.createScriptProcessor === undefined && Proto.createJavaScriptNode !== undefined) {
      Proto.createScriptProcessor = Proto.requestAnimationFrame;
    }
    ...
    jsmpeg.prototype.audioStart = function(file) {
        ...
        this.buffSource = new BuffAudio(jsmpegAudioContext, this.audioBuffer);
        this.buffSource.play();
    }
    ...
    jsmpeg.prototype.pause = function(file) {
      this.buffSource.pause();
      this.paused = true;
      this.playing = false;
    };

    jsmpeg.prototype.stop = function(pause) {
      if (this.buffer) {
      ...
      this.playing = false;
      // if (this.audioEnabled) this.audioSource.stop();
      if (this.audioEnabled) this.buffSource.stop();
    };
    ...
    jsmpeg.prototype.isPlaying = function() {
      return this.playing;
    };

    jsmpeg.prototype.getVideoTime = function() {
      return this.currentFrame / this.pictureRate;
    };
